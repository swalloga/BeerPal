...
Reservation.create!({user_id:6, bar_beer_id:7})
Reservation.create!({user_id:6, bar_beer_id:10})
Reservation.create!({user_id:6, bar_beer_id:16})
Reservation.create!({user_id:6, bar_beer_id:17})
Reservation.create!({user_id:6, bar_beer_id:18})
Reservation.create!({user_id:6, bar_beer_id:19})
Reservation.create!({user_id:7, bar_beer_id:8})
Reservation.create!({user_id:7, bar_beer_id:9})
Reservation.create!({user_id:7, bar_beer_id:10})
Reservation.create!({user_id:7, bar_beer_id:16})
Reservation.create!({user_id:7, bar_beer_id:17})
Reservation.create!({user_id:7, bar_beer_id:18})
Reservation.create!({user_id:7, bar_beer_id:19})
